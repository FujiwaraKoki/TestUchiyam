...
def regist(request):
    ...
    # regist_form = forms.RegistForm(request.method or None)
    print(f"regist_form: {regist_form}")
    # print(f"regist_form: {forms.RegistForm(request.method)}")
    # print(f"regist_form: {forms.RegistForm(request.POST)}")
    # print(f"regist_form: {forms.RegistForm(None)}")
